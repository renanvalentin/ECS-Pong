...
public partial class GameEntity {
    ...
    public void AddCollider(Entitas.IEntity newOther, float newFriction, UnityEngine.Vector2 newPoint, UnityEngine.Vector2 newNormal) {
    ...
    public void ReplaceCollider(Entitas.IEntity newOther, float newFriction, UnityEngine.Vector2 newPoint, UnityEngine.Vector2 newNormal) {
        var index = GameComponentsLookup.Collider;
        var component = CreateComponent<ColliderComponent>(index);
        component.other = newOther;
        component.friction = newFriction;
