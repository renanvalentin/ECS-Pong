...
public static class ContextsExtensions {
    ...
    public static GameEntity GetEntityWithPlayer(this GameContext context, string id) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.Player)).GetEntity(id);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
